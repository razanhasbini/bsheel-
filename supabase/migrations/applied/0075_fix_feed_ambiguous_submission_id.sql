-- ============================================================
-- MIGRATION 0075: Fix ambiguous submission_id in get_feed RPC
-- Table-qualify all column references in the reactions subquery.
-- Uses the new collab_groups / collab_group_members schema.
-- ============================================================
