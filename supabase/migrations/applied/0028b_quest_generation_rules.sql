-- ============================================================
-- MIGRATION 0028: Quest generation rules
-- - Never reassign quests the user already submitted/approved
-- - Rejected quests remain eligible
-- - Keep auth checks + per-quest duration-based expiry
-- ============================================================
...
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE EXCEPTION 'Quest already completed/submitted by user';
  END IF;
