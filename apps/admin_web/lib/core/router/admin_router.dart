...
import '../../features/agent_evidence/presentation/pages/agent_evidence_page.dart';
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: AdminRoutePaths.agentEvidence,
            name: AdminRouteNames.agentEvidence,
            builder: (context, state) => const AgentEvidencePage(),
          ),
          GoRoute(
